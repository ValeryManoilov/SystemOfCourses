...
public class CourseSystemDbMigrationService : ITransientDependency
{
    ...
    private readonly IEnumerable<ICourseSystemDbSchemaMigrator> _dbSchemaMigrators;
    ...
    public CourseSystemDbMigrationService(
        ...
        IEnumerable<ICourseSystemDbSchemaMigrator> dbSchemaMigrators)
    {
    ...
    private async Task SeedDataAsync(Tenant? tenant = null)
    {
        ...
        await _dataSeeder.SeedAsync(new DataSeedContext(tenant?.Id)
            .WithProperty(IdentityDataSeedContributor.AdminEmailPropertyName,
                CourseSystemConsts.AdminEmailDefaultValue)
            .WithProperty(IdentityDataSeedContributor.AdminPasswordPropertyName,
                CourseSystemConsts.AdminPasswordDefaultValue)
        );
    }
